...
if __name__ == "__main__":
    ...
    for epoch in range(args.epochs):
        ...
        for minibatch_index in tqdm(range(N // minibatch_size)):
            ...
            for example_index in range(minibatch_size):
                ...
                if predicted_label != gold_label:
                    ...
                    # print("input word",index2word[input_vector])
        ...
        avg_validation_acc += correct / total
        acc_list.append(correct / total)
        epoch_list.append(epoch+1)
        epochs += 1
        val_loss.append(loss.item())
    
    print("avg accuracy", avg_validation_acc/epochs)
    print(epoch_list)
    print(acc_list)
    print(training_acc)

    fig1 = plt.figure("Figure 1")
    plt.plot(epoch_list, acc_list, label = "Validation accuracy")    
    plt.plot(epoch_list, training_acc, label = "Training accuracy") 
    plt.xlabel('epochs') 
    plt.ylabel('Accuracy') 
    plt.title('FFNN Model') 
    plt.legend()
